...
public class Map extends JPanel {
  ...
  private ArrayList<GameObject> objectsPaintLater = new ArrayList<GameObject>();
  ...
  public void paint(Graphics g) {
    ...
    for (GameObject object : this.objects) {
      //Si notre object est un character on le met au dessus des autres blocs
  ...
  private void InventoryRight(Graphics g){
    //////////////PARTIE DROITE
    //le div permet une division de l'écran de manière à l'adapter pour y
    //ajouter le blastRange si le Player est un Mage
